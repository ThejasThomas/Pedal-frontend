...
export const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true);
                const response = await axiosInstance.get(`/admin/fetchDashboard?timeFilter=${timeFilter}`);
        ...
        <div className="container mx-auto p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                {[
                    ...
                    { title: "Total Sales", value: `$${dashboardData.totalSales.toFixed(2)}` },
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {/* <TopSellingItems 
                    ...
                    items={dashboardData.bestBrands} 
                /> */}
            </div>
        </div>
    );
